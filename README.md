...
| [Avito Split Detector](https://github.com/Ultramind-67/avito_hack_solution) | ML service for detecting split listings in marketplace-style data. The system combines structured features and text-based signals to identify cases where one real object may be represented by several duplicated or fragmented listings. | Python, CatBoost, TF-IDF, text features, tabular ML, FastAPI. Result: 2nd place in the Avito track at IT Purple Hack 2026. |
